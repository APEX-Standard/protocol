...
| Futures | Listed futures, contract chains, expiration, margin schedules | `v0.3-alpha` |
...
APEX is currently at version `0.3.0-alpha`. The protocol surface is organized into four stability classes:
